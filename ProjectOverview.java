       ...
       try (BufferedReader ProjectReader = new BufferedReader(new FileReader("CompletedTasks.txt"))) {
           while (ProjectReader.ready()) {
               ...
               //data types
                ...
                Architect architect = new Architect(temp[10], temp[11], Integer.parseInt(temp[12]), temp[13], temp[14]);
                Customer customer = new Customer(temp[15], temp[16], Integer.parseInt(temp[17]), temp[18], temp[19]);
                Contractor contractor = new Contractor(temp[20], temp[21], Integer.parseInt(temp[22]), temp[23], temp[24]);
           ...
           //Call scanner class to capture input
            ...
            if (userChoice.equals("1")) {
               ...
               //Enter project deadline
                ...
                Architect architect = new Architect(architectName, architectSurname, architectPhoneNumber, architectEmail,
                       architectAddress);

                //Create Customer
               
                Customer customer = new Customer(customerName, customerSurname, customerPhoneNumber, customerEmail, customerAddress);

                //Create Contractor
               
                Contractor contractor = new Contractor(contractorName, contractorSurname, contractorNumber, contractorEmail,
                       contractorAddress);
                ...
                System.out.println("Enter new project deadline date for example 12 November 2020:");
                ...
                while (true) {
                    try {
                        ...
                        input.nextLine();
                        ((Contractor) ProjectArray.get(contractorIndex).contractor).setContNum(newPhoneNumber);
                        break;
                    } catch ( Exception e) {
                        System.out.println("Please enter correct format");
                        input.next();
                ...
                ((Contractor) ProjectArray.get(contractorIndex).contractor).setContEmail(newEmailAddress);
